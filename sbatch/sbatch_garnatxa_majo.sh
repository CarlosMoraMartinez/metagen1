...
nextflow run all.nf -c config/run_samples_garnatxa_majo.config -profile conda -resume -with-timeline timeline.html -with-report report.html -with-dag pipeline_dag.html